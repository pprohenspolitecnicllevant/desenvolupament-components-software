...
|---|---|---|---|---|---|
| 5 | Introducció a xarxes neuronals supervisades: del perceptró al perceptró multicapa amb retropropagació | 28 | scikit-learn | 3.a, 3.f | carpeta `UT01-...`: NB 1.1, NB 1.2 i diapositives, **encara programats des de zero: cal adaptar-los** |
